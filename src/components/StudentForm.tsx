...
// We Omit 'id' because it's now auto-generated by the database.
type StudentFormData = Omit<Student, 'id' | 'created_at' | 'updated_at'>;
    ...
    <Card className="shadow-lg rounded-xl">
      <CardHeader>
        <CardTitle className="text-3xl font-headline text-primary">
          {isEditing ? `Edit ${student?.name || 'Student'}'s Profile` : 'Add New Student'}
        </CardTitle>
