...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://fqfnykwqscvaykhroazk.supabase.co");
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZxZm55a3dxc2N2YXlraHJvYXprIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQwNDQ2MjQsImV4cCI6MjA2OTYyMDYyNH0.G8hfZ4ITLumcmzim2927k3OLAIRk1C8z5N4s8cT3nSY");
...
const AppProvider = ({ children })=>{
    ...
    const [fybWeekGallery, setFybWeekGallery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "AppProvider.useEffect": ()=>{
            ...
            async function loadInitialData() {
                ...
                try {
                    ...
                    const fybGalleryRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('fyb_week_gallery').select('*').order('created_at', {
                        ascending: true
                    });
    ...
    const uploadFileToSupabase = async (fileBlob, pathPrefix, fileNameWithoutExt)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available for file upload.");
    ...
    const updateFybWeekSettings = async (settings)=>{
        ...
        const { data: currentData, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('app_settings').select('id').eq('id', APP_SETTINGS_ID).single();
        if (fetchError && fetchError.code !== 'PGRST116') throw fetchError;
        const currentSettings = currentData || {
            id: APP_SETTINGS_ID
        };
    ...
    const addAward = async (awardData)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available.");
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('awards').insert(awardData).select().single();
        if (error) throw error;
        setAwards((prev)=>[
                ...prev,
                data
    ...
    const deleteAward = async (awardId)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available.");
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('awards').delete().eq('id', awardId);
        if (error) throw error;
    ...
    const addNomination = async (nominationData)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available.");
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('award_nominations').insert(nominationData).select('*, students(name, image_src)').single();
        if (error) throw error;
        setNominations((prev)=>[
                ...prev,
                data
    ...
    const deleteNomination = async (nominationId)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available.");
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('award_nominations').delete().eq('id', nominationId);
        if (error) throw error;
    ...
    const addGalleryImage = async (eventId, fileDataUrl)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('fyb_week_gallery').insert({
            event_id: eventId,
            image_url: imageUrl
        }).select().single();
        if (error) {
    ...
    const deleteGalleryImage = async (imageId)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('fyb_week_gallery').delete().eq('id', imageId);
        if (error) throw error;
...
_s(AppProvider, "JT8JiHuLLlexJfSWAiHJDa4HDrE=", false, function() {
    return [
...
//# sourceMappingURL=src_7710d37a._.js.map