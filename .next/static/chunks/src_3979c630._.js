        ...
        "AppProvider.useEffect": ()=>{
            if (isDataFetched) {
                ...
                const timer = setTimeout({
                    "AppProvider.useEffect.timer": ()=>setIsLoading(false)
                }["AppProvider.useEffect.timer"], 250);
                return ({
...
_s(AppProvider, "3+ZHpAHhZiohGNgCdWUwqprLlro=");
_c = AppProvider;
const useAppContext = ()=>{
    _s1();
...
//# sourceMappingURL=src_3979c630._.js.map