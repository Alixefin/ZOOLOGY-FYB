...
const AppProvider = ({ children })=>{
    ...
    const [isLogoRendered, setIsLogoRendered] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadInitialData() {
            try {
                ...
                // Fetch students
                const { data: studentsData, error: studentsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('students').select('*').order('name', {
                    ascending: true
                });
...
Raw Error: ${extractedErrorMessage}`;
    ...
    const updateLogo = async (logoType, fileDataUrl)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"]) throw new Error("Supabase client not available for updating logo.");
        let newLogoUrl = null;
    ...
    const addStudent = async (studentData)=>{
        ...
        try {
            if (studentData.image_src && studentData.image_src.startsWith('data:')) {
                ...
                if (blob) {
                    profileImageUrl = await uploadFileToSupabase(blob, 'student_profiles', `profile_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}`);
                }
            }
        } catch (e) {
        ...
        try {
            if (studentData.flyer_image_src && studentData.flyer_image_src.startsWith('data:')) {
                ...
                if (blob) {
                    flyerImageUrl = await uploadFileToSupabase(blob, 'student_flyers', `flyer_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}`);
                }
            }
        } catch (e) {
        ...
        try {
            const { data: newStudent, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('students').insert(studentToInsert).select().single();
            if (error) throw error;
    ...
    const updateStudent = async (studentData)=>{
        ...
        try {
            ...
            const { data: updatedStudent, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('students').update(updateForDb).eq('id', studentData.id).select().single();
            if (error) throw error;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf52d852._.js.map